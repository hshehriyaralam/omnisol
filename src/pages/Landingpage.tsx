...
const Landingpage = () => {
  return (
    ...
    <SEO
     ...
     description="Omnisol AI helps businesses turn complex workflows and data into practical AI solutions, intelligent automation, and smarter decision-making."
