  ...
  return (
    <div className="w-full max-w-full sm:max-w-2xl md:max-w-4xl lg:max-w-5xl mx-auto    px-4 sm:px-6 lg:px-8 border border-uploadborder mt-8 sm:mt-10 md:mt-12 lg:mt-20 mb-8 sm:mb-10 md:mb-12 lg:mb-18  opacity-100 rotate-0 rounded-md p-6 bg-uploadbg">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <button
          type="button"
          className="flex items-center justify-center gap-2 border  border-foamtext text-formtext font-Roboto font-normal text-[16px] leading-6 tracking-[0px] text-center align-middle rounded-md px-5 py-2.5 transition-all duration-200"
        >
          <img src="/public/Upload/Upload.png" alt="Upload Icon" className="w-4 h-4" />
          Upload From Device
        </button>
      </div>
    </div>
