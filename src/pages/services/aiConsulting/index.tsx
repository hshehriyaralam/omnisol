...
const cardsData = [
  ...
  description="Get an actionable AI strategy from readiness assessment through opportunity mapping, prioritization, and a roadmap aligned with your business goals."
