...
const DigitalTransformation = () => {
  ...
  description="Modernize operations with a digital transformation plan that connects AI adoption, better customer experiences, and more efficient business processes."
