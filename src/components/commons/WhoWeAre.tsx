                        ...
                        <div className="w-full lg:w-3/5 mb-12 lg:mb-0">
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 font-main mt-8'>
                                <div className='px-4 md:px-6 py-6 md:py-7 border-2 border-who-border rounded-2xl'>
                                    <h4 className='font-medium text-xl md:text-2xl mb-3'>Quick Prototyping & Deployment</h4>
                                    <p className='font-normal text-base md:text-lg opacity-70 text-black'>Average project turnaround: 4–6 weeks</p>
                                </div>
                                <div className='px-4 md:px-6 py-6 md:py-7 border-2 border-who-border rounded-2xl'>
                                    <h4 className='font-medium text-xl md:text-2xl mb-3'>Leading AI Software Development Experts</h4>
                                    <p className='font-normal text-base md:text-lg opacity-70 text-black'>Delivered 200+ custom AI solutions, achieving an average ROI of 300% within the first 3 months</p>
                                </div>
                                <div className='px-4 md:px-6 py-6 md:py-7 shadow-[0_24px_184px_-10px_rgba(0,0,0,0.14)] rounded-2xl'>
                                    <h4 className='font-medium text-xl md:text-2xl mb-3'>AI-Powered Software Solutions</h4>
                                    <p className='font-normal text-base md:text-lg opacity-70 text-black'>Helping businesses streamline operations and enhance decision-making with AI-driven applications</p>
                                </div>
                                <div className='px-4 md:px-6 py-6 md:py-7 border-2 border-who-border rounded-2xl'>
                                    <h4 className='font-medium text-xl md:text-2xl mb-3'>Trusted by Industry Leaders</h4>
                                    <p className='font-normal text-base md:text-lg opacity-70 text-black'>Helping businesses streamline operations and enhance decision-making with AI-driven applications</p>
                                </div>
                            </div>
                        </div>
