      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row flex-wrap items-center">
          ...
          <div className="w-full lg:w-3/5 mb-12 lg:mb-0">
            ...
            <motion.div
              className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 font-main mt-8"
            ...
            >
              {[
                ...
                <motion.div
                  ...
                  className={`px-4 md:px-6 py-6 md:py-7 rounded-2xl ${
                    card.shadow
          ...
          <div className="w-full lg:w-2/5 lg:pl-8 relative">
            ...
            <button
              onClick={prevSlide}
              className="absolute   top-0 left-1/2 -translate-x-1/2 z-30 bg-white/90  backdrop-blur-sm  p-3 rounded-full border border-gray-300 hover:bg-gray-100  cursor-pointer transition-all  " 
            >
            ...
            <button
              onClick={nextSlide}
              className="absolute bottom-0 left-1/2 -translate-x-1/2 z-30 bg-white/90  backdrop-blur-sm p-2 rounded-full hover:bg-white p-3 rounded-full border border-gray-300 hover:bg-gray-100  cursor-pointer transition-all"
            >
                ...
                {[1, 2, 3, 4, 5].map((num) => (
                  <div key={num} className="px-2 py-4">
                    <div className="flex justify-center">
                      <img
                        src={`/tech_stats${num > 3 ? 3 : num}.webp`}
                        alt={`Tech Stats ${num}`}
