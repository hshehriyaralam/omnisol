...
// Grad and Noise classes (same as ReactBits)
class Grad {
  x: number;
  y: number;
  z: number;
...
const Waves: React.FC<WavesProps> = ({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      // Reset mouse state for next initialization
  ...
  return (
    <section className="relative w-full h-[600px]  text-white flex md:py-40 2xl:py-40 py-20 justify-center">
      ...
      <div className="relative z-10 text-center">
        <h2 className="font-main font-medium text-white text-[30px] md:text-[40px] 2xl:text-[40px] text-center">
          Calculate your project
        </h2>
        <p className="font-main text-center max-w-[300px] md:max-w-[550px] 2xl:max-w-[550px] font-medium text-white text-[16px] md:text-[20px] 2xl:text-[20px] mt-4">
          Here you can get a rough estimate of your future product and set budget frames.
        </p>
        <GradientButton
          text={"Start"}
          width="150px"
