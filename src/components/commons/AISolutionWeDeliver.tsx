  ...
  const cardsData = [
    {
      ...
      description:
        "Boost efficiency, cut costs, and make your systems run on autopilot.",
    ...
    },
    {
      ...
      description:
        "Bring intelligent digital products to life, from idea to prototype to production.",
        ...
        >
          ...
          >
            <HeadingSection
              ...
              Description="Since 2023, we've been helping businesses of all sizes design"
              align="left"
            />
          </div>
          ...
          >
            ...
            <img
              ...
              className="absolute lg:left-30 lg:w-[400px] lg:top-35 w-[180px] top-28 left-22"
              alt="Bowl-Image"
            />
            <img
              src="/Images/Landing/Finger.webp"
              className="absolute lg:-left-30 lg:w-[600px] lg:top-74 w-[300px] top-[180px] -left-9"
              alt="finger-Image"
            />
          </div>
        </motion.div>
