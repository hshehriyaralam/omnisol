              ...
              return (
                ...
                >
                  ...
                  <div className="lg:hidden flex items-start gap-3 mb-3 justify-start">
                    <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-[#EDFFF2] flex items-center justify-center">
                      {Icon}
                    </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-[14px] sm:text-[15px] font-main font-medium leading-[20px] opacity-90">
                        {card.description}
                      </p>
                    </div>
