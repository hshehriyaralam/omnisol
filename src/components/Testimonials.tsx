...
const Testimonials = () => {
  ...
  <div className={`flex flex-col md:flex-row gap-8 md:gap-12 px-4 py-8 md:mx-40 2xl:mx-60 text-center md:text-left 2xl:text-left`}>
    ...
    <div className={`flex flex-col justify-center flex-1 gap-4`}>
      ...
      <h2 className={`font-main font-medium text-[26px] md:text-[36px] 2xl:text-[36px] leading-[110%] md:leading-[42px] tracking-[-0.01em] text-black`}>
    ...
    <div className="relative overflow-hidden">
      ...
      >
        ...
        <div className="sm:hidden mt-3 text-center font-main">
          <h4 className="font-semibold text-base">{testimonials[activeTestimonial].name}</h4>
          <span className="font-regular text-sm text-gray-600">{testimonials[activeTestimonial].position}</span>
        </div>
      </div>
    </div>
  </div>
